...
TEST_F(BettingContextTest, bettingContextHasManyRaisesIfNumbeOfRaisesIsHigherThan2) {
    pokerGame::modeling::BettingContext bettingContext(A_BETTING_ROUND_TYPE, A_HIGH_NUMBER_OF_RAISES, A_LOW_NUMBER_OF_PLAYERS);
    bool hasManyRaises = bettingContext.hasManyRaises();
...
TEST_F(BettingContextTest, twoBettingContextsAreEqualsIfEveryMembersAreQeuals) {
    pokerGame::modeling::BettingContext bettingContext(A_BETTING_ROUND_TYPE, A_LOW_NUMBER_OF_RAISES, A_HIGH_NUMBER_OF_PLAYERS);
    pokerGame::modeling::BettingContext anotherContext(A_BETTING_ROUND_TYPE, A_LOW_NUMBER_OF_RAISES, A_HIGH_NUMBER_OF_PLAYERS);
...
TEST_F(BettingContextTest, twoBettingContextsAreNotEqualsIfEveryMembersAreNotEquals) {
    pokerGame::modeling::BettingContext bettingContext(A_BETTING_ROUND_TYPE, A_LOW_NUMBER_OF_RAISES, A_HIGH_NUMBER_OF_PLAYERS);
    pokerGame::modeling::BettingContext anotherContext(A_BETTING_ROUND_TYPE, A_HIGH_NUMBER_OF_RAISES, A_HIGH_NUMBER_OF_PLAYERS);
