...
TEST_F(HandContextTest, canGetHandStrength) {
    ...
    pokerGame::modeling::ActionContext actionContext(pokerGame::modeling::BettingContext(A_BETTING_ROUND_TYPE, A_NUMBER_OF_RAISES, A_NUMBER_OF_PLAYERS), aDecision);
...
TEST_F(HandContextTest, hasSameActionContextReturnsFalseWhenActionContextIsDifferent) {
    pokerGame::Decision aDecision = {pokerGame::RAISE, A_BET};
    pokerGame::modeling::ActionContext actionContext(pokerGame::modeling::BettingContext(A_BETTING_ROUND_TYPE, A_NUMBER_OF_RAISES, A_NUMBER_OF_PLAYERS), aDecision);
    pokerGame::modeling::ActionContext aDifferentActionContext(pokerGame::modeling::BettingContext(A_BETTING_ROUND_TYPE, A_NUMBER_OF_RAISES, ANOTHER_NUMBER_OF_PLAYERS), aDecision);
    pokerGame::modeling::HandContext handContext(actionContext, HAND_STRENGTH);
