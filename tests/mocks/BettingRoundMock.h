...
namespace test
{
    ...
    {
        public:
        MOCK_METHOD5(start, void(std::vector<pokerGame::PokerPlayer*> roundPlayers, float blind, int dealerPlayerIndex, int bigBlindPlayerIndex, int smallBlindPlayerIndex));
