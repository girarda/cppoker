...
namespace test
{
    ...
    {
        public:
        MOCK_METHOD5(makeDecision, pokerGame::Decision(std::vector<pokerGame::Card> hole, std::vector<pokerGame::Card> sharedCards, float minBet, float bigBlind, int numberOfRaises));
