...
inline void save_construct_data(
    Archive & ar, const pokerGame::simulation::HoleCardsEquivalence * t, const unsigned int file_version) {
...
template<class Archive>
inline void load_construct_data(Archive & ar, pokerGame::simulation::HoleCardsEquivalence * t, const unsigned int file_version) {
    ...
    ::new(t)pokerGame::simulation::HoleCardsEquivalence(number1, number2);
}
}
}
